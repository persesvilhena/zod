<title>Zone Of Death - Administração</title>
<?php include "includes/cabeca.dll" ?>
<?php include "includes/selectadmin.dll" ?>
<div id="corpo">
	...
	<div id="news" style="position: relative; left: 205px; top: -7px; width: 795px;">
		<span class="texto"><?php include "includes/ct.dll" ?><strong>em construcao</strong><?php include "includes/ft.dll" ?></span>
		<?php include "includes/cb.dll" ?>---
		<?php include "includes/fb.dll" ?>
	</div>
